...
export default function Page() {
  return (
    <div className="w-full  grid grid-cols-3 gap-5 max-lg:grid-cols-1 max-lg:grid-rows-[auto]">
      <div className="col-span-2 max-lg:row-start-2 row-span-1 rounded-3xl max-lg:col-span-1 flex flex-col gap-5 justify-between">
        <Image src={map} alt="map image" className="object-fill w-full  " />
        <div className="flex justify-between items-center gap-2 flex-wrap">
          <div className="py-2 px-6 flex flex-col items-start gap-1 rounded-xl bg-lightBLue">
            <span>Address:</span>
      ...
      <div className="col-span-1 max-lg:row-start-1 row-span-1">
